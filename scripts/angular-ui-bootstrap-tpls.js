                        ...
                        return f.hasClass("collapse") || f.hasClass("in")
                            ? void b.resolve(p(d)).then(function () {
                                  f
                                      ...
                                      .attr("aria-hidden", !0),
                                      e
                                          ? e(f, { removeClass: "in", to: t })
                                                .start()
                                                ["finally"](m)
                                          : a
                                                .removeClass(f, "in", { to: t })
                                                .then(m);
                              }, angular.noop)
                            : m();
                    }
        ...
        .directive("uibAccordion", function () {
            return {
                ...
                templateUrl: function (a, b) {
                    return (
                        b.templateUrl || "uib/template/accordion/accordion.html"
                    );
                },
            };
        })
    ...
    angular
            ...
            function (a, b, c, d, e) {
                ...
                b.addClass("carousel"),
                    ...
                    (o.select = a.select = function (b, c) {
                        var d = h(b.slide);
                        void 0 === c &&
                            (c = d > o.getCurrentIndex() ? "next" : "prev"),
                            b.slide.index === r ||
                                a.$currentTransition ||
                                g(b.slide, d, c);
                    }),
        ...
        .directive("uibCarousel", function () {
            return {
                ...
                templateUrl: function (a, b) {
                    return (
                        b.templateUrl || "uib/template/carousel/carousel.html"
                    );
                },
                scope: {
                    active: "=",
        ...
        .directive("uibSlide", [
            ...
            function (a) {
                return {
                    ...
                    templateUrl: function (a, b) {
                        return (
                            b.templateUrl || "uib/template/carousel/slide.html"
                        );
                    },
                    scope: { actual: "=?", index: "=?" },
                    link: function (b, c, d, e) {
        ...
        function (a, b, c, d, e) {
            ...
            (this.init = function () {
                (r = b.id),
                    ...
                    (s = [
                        {
                            ...
                            formatter: function (a) {
                                var b = new Date();
                                return (
                                    b.setFullYear(Math.abs(a.getFullYear())),
                                    c(b, "yyyy")
                                );
                            },
                        },
                        ...
                        },
                        {
                            ...
                            apply: function (a) {
                                this.month = b.DATETIME_FORMATS.MONTH.indexOf(
                                    a
                                );
                            },
                            formatter: function (a) {
                        ...
                        },
                        {
                            ...
                            apply: function (a) {
                                this.month = b.DATETIME_FORMATS.SHORTMONTH.indexOf(
                                    a
                                );
                            },
                            formatter: function (a) {
                        ...
                        {
                            key: "GGGG",
                            regex: b.DATETIME_FORMATS.ERANAMES.join(
                                "|"
                            ).replace(/\s/g, "\\s"),
                            formatter: function (a) {
                                return c(a, "GGGG");
                    ...
                    angular.version.major >= 1 &&
                        ...
                        s.push({
                            ...
                            apply: function (a) {
                                this.month = b.DATETIME_FORMATS.STANDALONEMONTH.indexOf(
                                    a
                                );
                            },
                            formatter: function (a) {
                ...
                (this.overrideParser = function (a, b) {
                    var c = f(a);
                    c &&
                        angular.isFunction(b) &&
                        ((this.parsers = {}), (c.apply = b));
                }.bind(this)),
    ...
    angular
        ...
        .controller("UibDatepickerController", [
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l) {
                ...
                b.addClass("uib-datepicker"),
                        ...
                        switch (b) {
                            ...
                            case "startingDay":
                                angular.isDefined(
                                    ...
                                    : (o.startingDay =
                                          (f.DATETIME_FORMATS.FIRSTDAYOFWEEK +
                                              8) %
                                          7);
                                break;
                            case "maxDate":
                            case "minDate":
                                a.$watch("datepickerOptions." + b, function (
                                    a
                                ) {
                                    a
                                        ? angular.isDate(a)
                    ...
                    (a.isActive = function (b) {
                        return 0 === o.compare(b.date, o.activeDate)
                    ...
                    (this.render = function () {
                        if (p.$viewValue) {
                            var a = new Date(p.$viewValue),
                                b = !isNaN(a);
                            b
                                ? (this.activeDate = l.fromTimezone(
                                      a,
                                      q.getOption("timezone")
                                  ))
                                : k ||
                    ...
                    (a.select = function (b) {
                        if (a.datepickerMode === o.minMode) {
                            ...
                            (o.activeDate = b),
                                m(
                                    o.modes[
                                        o.modes.indexOf(a.datepickerMode) - 1
                                    ]
                                ),
                    ...
                    (a.toggleMode = function (b) {
                        (b = b || 1),
                            (a.datepickerMode === o.maxMode && 1 === b) ||
                                ...
                                (m(
                                    o.modes[
                                        o.modes.indexOf(a.datepickerMode) + b
                                    ]
                                ),
                                a.$emit("uib:datepicker.mode"));
                    }),
            ...
            function (a, b, c) {
                ...
                (this.step = { months: 1 }),
                    ...
                    (this.getDates = function (a, b) {
                        for (
                            var c, d = new Array(b), e = new Date(a), f = 0;
                            b > f;
        ...
        .directive("uibMonthpicker", function () {
            return {
                templateUrl: function (a, b) {
                    return (
                        b.templateUrl || "uib/template/datepicker/month.html"
                    );
                },
            ...
            return {
                ...
                offsetParent: function (c) {
                    function d(a) {
                        return (
                            "static" ===
                            (b.getComputedStyle(a).position || "static")
                        );
                    }
                    c = this.getRawNode(c);
                    for (
                ...
                scrollParent: function (c, d, f) {
                    ...
                    for (; k.parentElement && k !== h; ) {
                        ...
                        if (
                            ...
                            !j &&
                                g.test(l.overflow + l.overflowY + l.overflowX))
                        )
                            break;
                        k = k.parentElement;
                    }
                    ...
                    p.$watch("isOpen", function (e, n) {
                        ...
                        if (e)
                            o.dropdownMenuTemplateUrl
                                ? k(o.dropdownMenuTemplateUrl).then(function (
                                      a
                                  ) {
                                      (m = p.$new()),
        ...
        .directive("uibModalWindow", [
            ...
            function (a, b, c, d) {
                return {
                    ...
                    templateUrl: function (a, b) {
                        return (
                            b.templateUrl || "uib/template/modal/window.html"
                        );
                    },
                    link: function (e, f, g) {
        ...
        .factory("$uibModalStack", [
            ...
            function (a, b, c, d, e, f, g, h, i) {
                ...
                function p(b, c, d, e) {
                    ...
                    return (
                        c.$broadcast(z.NOW_CLOSING_EVENT, j), f.when(i).then(g)
                    );
                }
                function q(a) {
                        ...
                        switch (a.which) {
                            ...
                            case 9:
                                var c = z.loadFocusElementList(b),
                                    d = !1;
                                a.shiftKey
                                    ? (z.isFocusInFirstItem(a, c) ||
                                          z.isModalFocused(a, b)) &&
                    ...
                    (z.open = function (b, f) {
                        function g(a) {
                            function b(a) {
                                ...
                                return Array.prototype.filter.call(b, function (
                                    b
                                ) {
                                    return b !== a[0];
                                });
                    ...
                    (z.loadFocusElementList = function (a) {
                        if (a) {
                            ...
                            if (b && b.length) {
                                ...
                                return c
                                    ? Array.prototype.filter.call(c, function (
                                          a
                                      ) {
                                          return k(a);
                                      })
            ...
            return {
                create: function (b, c, d) {
                    (b.setNumPages = d.numPages
                        ...
                        (b.render = function () {
                            c.page =
                                parseInt(b.ngModelCtrl.$viewValue, 10) || 1;
                        }),
                                        ...
                                        return function (a, b, d, f) {
                                            ...
                                            function x() {
                                                (P.title = d[k + "Title"]),
                                                    ...
                                                    (P.popupClass =
                                                        d[k + "Class"]),
                                                    (P.placement = angular.isDefined(
                                                        d[k + "Placement"]
                                                    )
                                                        ? d[k + "Placement"]
                                                        : n.placement);
                                                var b = i.parsePlacement(
                                                    P.placement
                                                );
                                                L = b[1]
                                                    ? b[0] + "-" + b[1]
                                                ...
                                                (P.popupDelay = isNaN(c)
                                                    ? n.popupDelay
                                                    : c),
                                                    (P.popupCloseDelay = isNaN(
                                                        f
                                                    )
                                                        ? n.popupCloseDelay
                                                        : f);
                                            ...
                                            P.animation = angular.isDefined(W)
                                                ? !!W
                                                : n.animation;
                                            var X,
                                                Y = k + "AppendToBody";
            ...
            function (a, b, c, d) {
                return {
                    link: function (e, f, g) {
                        ...
                        e.$watch(
                            b.parseAsResourceUrl(
                                g.uibTooltipTemplateTransclude
                            ),
                            function (b) {
                                var g = ++l;
                                b
        ...
        .controller("UibTimepickerController", [
            ...
            function (a, b, c, d, e, f, g) {
                ...
                var s,
                    ...
                    z = angular.isDefined(c.padHours)
                        ? a.$parent.$eval(c.padHours)
                        : !0;
                (a.tabindex = angular.isDefined(c.tabindex) ? c.tabindex : 0),
                    ...
                    (this.init = function (b, d) {
                        ...
                        j && this.setupArrowkeyEvents(e, f, h),
                            (a.readonlyInput = angular.isDefined(
                                c.readonlyInput
                            )
        ...
        .controller("UibTypeaheadController", [
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                ...
                var x,
                    ...
                    C = angular.isDefined(c.typeaheadSelectOnBlur)
                    ...
                    E = c.typeaheadInputFormatter
                        ? e(c.typeaheadInputFormatter)
                        : void 0,
                    F = c.typeaheadAppendToBody
                        ? a.$eval(c.typeaheadAppendToBody)
                        : !1,
                    G = c.typeaheadAppendTo
                        ? a.$eval(c.typeaheadAppendTo)
                        : null,
                    H = a.$eval(c.typeaheadFocusFirst) !== !1,
                    I = c.typeaheadSelectOnExact
                    ...
                    M = e(c.ngModel + "($$$p)"),
                    N = function (b, c) {
                        return angular.isFunction(L(a)) &&
                            r.getOption("getterSetter")
                            ? M(b, { $$$p: c })
                            : L.assign(b, c);
                    },
                ...
                var Y = function (a, b) {
                        return P.matches.length > b && a
                            ? a.toUpperCase() ===
                                  P.matches[b].label.toUpperCase()
                            : !1;
                    },
                    Z = function (c, d) {
                        var e = { $viewValue: c };
                    ...
                    b.on("keydown", function (b) {
                        if (
                            ...
                            switch (b.which) {
                                ...
                                case 40:
                                    (P.activeIdx =
                                        (P.activeIdx + 1) % P.matches.length),
                                        P.$digest(),
                                        (d = U[0].querySelectorAll(
                                            ".uib-typeahead-match"
                                        )[P.activeIdx]),
                ...
                F
                    ...
                    : G
                    ? angular.element(G).eq(0).append(da)
                    : b.after(da),
                    (this.init = function (b) {
                        (q = b),
                            (r = p(q)),
